# Local CAD Assistant Report: part_003

## Task Summary

- Input views: `examples/part_003/views/view_0.png` ... `view_7.png`
...
- Best STEP: `outputs/part_003/candidate_2.step`
- Best STL: `outputs/part_003/candidate_2.stl`

## Geometry Quality

- Watertight: yes
- Mean bbox relative error: 0.078
- Volume relative error: 1.225
- Normalized Chamfer distance: 0.003

## ROCm Inference Evidence

- GPU: AMD Radeon Graphics
- HIP version: 7.12.60610-2bd1678d3d
- Average inference latency: 12.67 sec
- Average generated throughput: 28.03 tokens/sec
...
| error type | count |
|---|---:|
| OCP.OCP.Standard.Standard_OutOfRange | 1 |